...
function buildPredForm(features) {
  ...
  grid.innerHTML = features.map(f => {
    let min = '', max = '', step = '0.01', placeholder = '0.0';
    if (datasetStats && datasetStats.min && datasetStats.min[f] != null) {
    ...
    return `
      <div class="col-md-6 col-lg-4">
        ...
        <input type="number" id="feat_${f.replace(/[^a-z0-9]/gi,'_')}"
